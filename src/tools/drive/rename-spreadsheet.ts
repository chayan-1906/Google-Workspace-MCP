            ...
            try {
                ...
                return {
                    content: [
                        {
                            type: 'text',
                            text: `Spreadsheet *${spreadsheetId}* renamed to *${sheetName}* successfully! ✅`,
                        },
                    ],
                };
            } catch (error: any) {
                sendError(transport, new Error(`Failed to rename spreadsheet: ${error}`), tools.renameSpreadsheet);
                return {
                    content: [
                        {
                            type: 'text',
